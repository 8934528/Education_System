...
{
    public partial class ProjectManagerCourses : System.Web.UI.Page
    {
        ...
        protected void btnSuscribe_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "alert", "alert('Subscription successful!'); window.location = 'EnrollProjectManagement.aspx';", true);
        }
    }
}