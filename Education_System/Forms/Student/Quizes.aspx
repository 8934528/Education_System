<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Student/Student.Master" AutoEventWireup="true" CodeBehind="Quizes.aspx.cs" Inherits="Education_System.Forms.Student.Quizes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="folder-container">
        <a class="folder" href="QuizIntroProgr.aspx">
            <h3>Quiz 1</h3>
        </a>
