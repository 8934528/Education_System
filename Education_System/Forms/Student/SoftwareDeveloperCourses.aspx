<%@ Page Title="Software Developer Courses" Language="C#" MasterPageFile="~/Forms/Student/Student.Master" AutoEventWireup="true" CodeBehind="SoftwareDeveloperCourses.aspx.cs" Inherits="Education_System.Forms.Student.SoftwareDeveloperCourses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Software Developer Courses</h2>

    <div class="course-container">
        <div class="course-card">
            <div class="course-title">Introduction to Programming</div>
            <div class="course-description">Learn the basics of programming with hands-on coding exercises.</div>
            <a href="EnrollIntroToProgramming.aspx" class="course-link">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Web Development Basics</div>
            <div class="course-description">Explore HTML, CSS, and JavaScript to build interactive websites.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Software Development Lifecycle</div>
            <div class="course-description">Understand the stages of software development from planning to deployment.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Advanced C# Programming</div>
            <div class="course-description">Deep dive into C# programming with advanced topics and projects.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Database Management Systems</div>
            <div class="course-description">Learn about database design, SQL, and data management.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>
    </div>
