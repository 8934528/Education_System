<%@ Page Title="Digital Marketing Manager Courses" Language="C#" MasterPageFile="~/Forms/Student/Student.Master" AutoEventWireup="true" CodeBehind="DigitalMarkerCourses.aspx.cs" Inherits="Education_System.Forms.Student.DigitalMarkerCourses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Courses to Become a Digital Marketing Manager</h2>

    <div class="course-container">
        <div class="course-card">
            <div class="course-title">Digital Marketing Fundamentals</div>
            <div class="course-description">Learn the basics of digital marketing, including SEO, SEM, and social media strategies.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Content Marketing Strategy</div>
            <div class="course-description">Understand how to create and implement a successful content marketing strategy.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Social Media Marketing</div>
            <div class="course-description">Master the skills to effectively market on various social media platforms.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Email Marketing Techniques</div>
            <div class="course-description">Learn best practices for email marketing and building effective email campaigns.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">SEO and Analytics</div>
            <div class="course-description">Optimize your website and use analytics to track and improve performance.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>

        <div class="course-card">
            <div class="course-title">Pay-Per-Click Advertising</div>
            <div class="course-description">Learn how to create and manage successful PPC advertising campaigns.</div>
            <a href="#" class="course-link" onclick="openSubscriptionModal()">Enroll Now</a>
        </div>
    </div>
    ...
    <script>
        ...
        function submitForm() {
            ...
            window.location.href = "EnrollWebDevelopmentBasics.aspx";
        }
    </script>
